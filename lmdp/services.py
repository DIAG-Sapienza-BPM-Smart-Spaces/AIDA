...
class Service:
    ...
    def get_info(self):
        """Retrieve a string containing service properties"""
        s = f"\ttransitions: {self.transition_function}\n"
        s += f"\tinitial_state: {self.initial_state}\n"
        s += f"\tfinal_states: {self.final_states}"
        return s
